      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
          <div className="bg-gradient-to-br from-blue-50 to-white rounded-xl shadow-lg p-6 sm:p-8 border border-blue-100 text-center hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600">Jl. Kesehatan No. 123<br />Kota Administrasi<br />Indonesia 12345</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-white rounded-xl shadow-lg p-6 sm:p-8 border border-blue-100 text-center hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600">(021) 8765-4321</p>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-white rounded-xl shadow-lg p-6 sm:p-8 border border-blue-100 text-center hover:shadow-xl transition-shadow">
            ...
            <p className="text-blue-600 font-medium break-all mb-2">psdk@dinkes.go.id</p>
            <p className="text-blue-600 font-medium break-all">info@dinkes.go.id</p>
